...
export const getAllUsersApi = async (token) => {
  try {
    const req = await fetch(`${API_BASE_URI}/users/`, {
      method: "GET",
      headers: {
...
export const registerUserAPI = async (body) => {
    try {
      const req = await fetch(`${API_BASE_URI}/users/register`, {
        method: "POST",
        headers: {
  ...
  //Update User
export const updateUserAPI = async (id, body, token) => {
  try {
    console.log(token)
      const req = await fetch(`${API_BASE_URI}/users/${id}`, {
      method: "PATCH",
  ...
  //Update User
  export const DeleteUserAPI = async ({user, token}) => {
    console.log("***", user)
    const {_id} = user
